...
[['1　负责实验室场地适配',
 ...
 ['2　负责平台配套设备、试剂的供应',
  '附件一所列设备与器具**由我方全部投入**。设备后续将随分子诊断中心整体迁至新址，该处无既有设备，故清单不设「沿用院方现有设备」口径。试剂按院方确定的拟开展检测项目供应，每一癌种可包含多个检测项目及多个试剂盒，**全程冷链配送至太湖新城总院区实验室**，服务期内持续稳定供应；**所供试剂盒须取得国家药品监督管理局第三类医疗器械注册证，注册证在有效期内，注册适用范围覆盖对应癌种，且注册证载明的适用机型包含 MGISEQ-2000。**设备、试剂供应以满足实验室项目开展的需求为标准。'],
 ['3　负责质量管理体系建设，协助室间质评',
 ...
 ['4　负责 NGS 项目技术转移与驻场支持',
  '负责人员带教与标准化流程输出，内容覆盖样本前处理、文库构建、杂交捕获、上机测序、数据分析与报告解读全流程，**直至院方人员具备独立操作能力**。**前期派驻技术人员 1–2 名驻场配合，具体人数按院方实际需求与样本量确定**；培训形成书面记录与考核结论。'],
 ['5　负责临床沟通与报告解读支持',
...
k.push(H2('人员规划'));
k.push(P('我方设项目负责人 1 名；**前期派驻技术人员 1–2 名**，具备分子诊断或临床检验相关背景并持临床基因扩增检验实验室技术人员上岗证，负责带教、技术对接与日常运行配合。**驻场人数按院方实际需求与样本量调整**，待院方人员具备独立操作能力后转为定期回访与按需响应。'));
