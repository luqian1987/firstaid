...
k.push(H2('服务内容'));
[['1　负责实验室场地适配',
  '本项目使用太湖新城总院区现有 PCR 多分区实验室，**不涉及新建与装修改造**。负责设备进场前的现场勘察，就台面承重、供电、给排水、温湿度与网络接入提出书面要求；测序室边台改造为称重桌，以及设备就位所需的其他局部适配调整，由我方负责实施，费用计入报价，直至各功能分区满足临床项目开展的场地要求。'],
 ['2　负责平台配套设备、试剂的供应',
  '附件一所列设备与器具**由我方全部投入**。设备后续将随分子诊断中心整体迁至新址，该处无既有设备，故清单不设「沿用院方现有设备」口径。试剂按院方确定的拟开展检测项目供应，每一癌种可包含多个检测项目及多个试剂盒；**所供试剂盒须取得国家药品监督管理局第三类医疗器械注册证，注册证在有效期内，注册适用范围覆盖对应癌种，且注册证载明的适用机型包含 MGISEQ-2000。**设备、试剂供应以满足实验室项目开展的需求为标准。'],
 ['3　负责质量管理体系建设，协助室间质评',
  '负责平台检测项目的标准化操作文件及实验室其他质量管理体系文件的建立；配合完成方法学性能验证（精密度、正确度、检出限、可报告范围等），**性能验证在院方指定的场地与设备上进行，验证结论由院方确认，未通过验证的产品予以更换**；协助完成并上报室间质评结果；配合院方通过临床基因扩增检验实验室技术审核。'],
 ['4　负责标本运输和冷链物流',
  '负责检测试剂的冷链配送，保证服务期内持续稳定供应。院区间标本归拢的范围、频次与承担方式，按院方实际需要另行商定。'],
 ['5　负责 NGS 项目技术转移',
  '负责人员带教与标准化流程输出，内容覆盖样本前处理、文库构建、杂交捕获、上机测序、数据分析与报告解读全流程，**直至院方人员具备独立操作能力**；提供临床检验项目沟通与疑难病例报告解读等服务保障；提供与临床科室之间的学术交流支持。'],
 ['6　负责项目推广',
  '有专人负责区域业务拓展与临床科室沟通，配合院方提升本平台的临床应用与检测量。'],
 ['7　负责数据安全与本地化部署',
...
k.push(H2('人员规划'));
k.push(P('我方设项目负责人 1 名；**派驻技术人员 1 名**，具备分子诊断或临床检验相关背景并持临床基因扩增检验实验室技术人员上岗证，负责带教、技术对接与运行配合，**直至院方人员具备相应能力后转为定期回访与按需响应**。'));
k.push(P('院方按拟开展项目与预估样本量测算所需检验人员数量并负责招聘，**相关人员待遇由我方承担**。我方人员进入实验室遵守院方生物安全、感染控制与信息安全的相关规定并签署保密承诺；检验报告由院方具备相应资质的人员审核签发。'));
...
k.push(H2('附件一：设备清单'));
k.push(P('本清单共 ' + D.total + ' 项、' + D.qty + ' 台（件），**由我方全部投入**，按房间与步骤列明。厂商与规格型号为建议配置，可结合院方使用习惯调整。'));
