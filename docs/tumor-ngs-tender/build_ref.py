...
EMERG=[
 ("测序仪等核心设备故障",
  ...
  "2. 无法在约定时限内修复的，提供同等性能备机；或协助将样本外送至具备临床基因扩增检验实验室资质"
  "及相应检测项目能力的第三方医学检验机构检测，委托检验另行签订协议并报院方备案。"),
 ("试剂与耗材供应中断",
  "1. 建立安全库存，提前告知供应风险；<br>"
  "2. 由我方其他仓库临时调拨，并联系厂家及时恢复供应。"),
 ("样本质量不合格或建库、捕获失败",
  "1. 出具不合格原因说明，包括 DNA 得率与完整性、肿瘤细胞含量、文库浓度与片段分布等质控数据；<br>"
  "2. 属产品或技术原因的，免费提供重新建库所需试剂并配合重测；需重新取材的，配合院方完成样本补充。"),
 ("检测报告超期",
  "1. 提前告知延期原因与预计出报告时间；<br>"
  "2. 因我方设备、试剂或技术支持原因导致超期的，按合同约定承担责任并提出改进措施。"),
 ("检测结果争议与复核",
  "1. 配合院方开展原因调查，提供批次记录、质控数据、原始下机数据与方法学资料；<br>"
  "2. 必要时以原样本重新检测或以其他方法学验证；确因产品或服务原因造成损失的，"
  "承担相应责任并补充制定防范措施。"),
 ("数据或分析系统异常",
