...
k.push(P('（三）**报价方式**：试剂以**折扣率**形式报价。基准价为生产厂家公开挂牌价，或江苏省药品（医用耗材）集中采购平台挂网价；投标人须提供基准价的依据材料。**试剂报价原则上不高于基准价的五折**。所报折扣率在服务期内保持不变，基准价发生调整的，按调整后的基准价与所报折扣率执行；**所投试剂纳入国家或省级集中带量采购范围的，按中选结果执行。**'));
k.push(P('（四）**性能验证**：所投试剂盒须通过院方组织的方法学性能验证方可用于临床检测，验证结论由院方确认；未通过验证的产品应予更换。'));
k.push(P('（五）**供应保障**：中标人应保证试剂在服务期内的持续稳定供应，并按院方需求提供冷链配送。'));
k.push(P('（六）**政策衔接**：服务期内，国家或江苏省调整医疗服务价格项目、医用耗材集中采购或价格管理政策的，本项目的检测项目设置、收费执行与试剂结算方式**按调整后的政策执行**；**因政策调整致使原报价基础发生实质变化的，双方应就试剂折扣率另行协商调整。**'));
...
k.push(new Paragraph({ children: runs('注：上列为各癌种的**核心检测基因，属最低检测范围要求**。投标产品的检测范围可宽于上列内容，**覆盖更多靶点的产品不因此受限**；投标人应在投标文件中列明所投产品的完整检测范围。检测项目的收费按国家及江苏省现行医疗服务价格政策执行，现行适用收费编码 012100000200000「高通量测序法检测费（病理样本）」；**国家层面已发布检验类医疗服务价格项目立项指南，江苏省对接落地后，本项目的收费项目、计价单位与价格以届时执行的政策为准。**检测项目的最终开展范围，以院方完成新增项目论证与物价备案后的结果为准。', { size: 19 }),
